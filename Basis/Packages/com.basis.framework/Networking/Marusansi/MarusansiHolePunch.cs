...
namespace Basis.Scripts.Networking.Marusansi
{
    ...
    /// </summary>
    public static class MarusansiHolePunch
    {
        ...
        private static MarusansiTurnClient _turnClient;
        ...
        /// </summary>
        public static void StartHost(string noteId, MarusansiTurnClient turnClient = null)
        {
            StopHost();
